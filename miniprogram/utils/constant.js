...
// 同时决定「取件码 / 帮带物品」哪个是必填项（与后端 taskController 口径一致）
const TASK_TYPE = {
  0: '其他',
  1: '取快递',
  2: '食堂带饭',
...
// ---------------------- 雇主举报接单人的原因标签 ----------------------
// 任务被接单后，雇主在任务详情页勾选这些标签举报接单人（report_type = 3）；
// 选择「其他」时必须填写补充说明（不少于 5 个字，前后端同一口径）
...
//        本常量与后端 backend/src/utils/constant.js 完全一致
...
const REPORT_TYPE_ENUM = {
  ...
  OWNER_REPORT_TAKER: 3  // 雇主举报接单人（任务被接单后）
};

// 选择该标签时，前端必须显示输入框让用户填写补充说明
...
const BIZ = {
  ...
  // 帮带物品名称长度上限（与后端 BIZ.ITEM_NAME_MAX 完全一致）
  ITEM_NAME_MAX: 60,
...
const MSG = {
  ...
  ACCOUNT_NO_AVAILABLE: '此账号ID无人使用，可以注册',
  ...
  // ---------------- 暗色模式（跟随系统 + 首页滑动开关） ----------------
  // 开关右侧的状态文字：跟随系统 / 浅色 / 深色（对应 users 本地缓存 themeMode 的三档取值）
  THEME_LABEL_AUTO: '跟随系统',
  THEME_LABEL_LIGHT: '浅色',
  THEME_LABEL_DARK: '深色',
  THEME_TOAST_LIGHT: '已切换为浅色模式',
  THEME_TOAST_DARK: '已切换为深色模式',
  THEME_TOAST_AUTO: '已恢复为跟随系统深浅色',
  // 手动切换后的提示尾巴：让「长按可恢复跟随系统」这件事被发现，否则这个能力等于不存在
  THEME_TOAST_HINT: '，长按开关可恢复跟随系统',
  // ---------------- 通用确认弹窗（自绘，深色自适应） ----------------
  DIALOG_CONFIRM: '确定',
  DIALOG_CANCEL: '取消',
  // ---------------- 消息中心：常显操作条 ----------------
  MSG_ACTION_READ_ALL: '全部已读',
  MSG_UNREAD_COUNT: '{count} 条未读',
  MSG_NO_UNREAD: '没有未读消息',
  MSG_ACTION_DELETE_ALL: '全部删除',
  MSG_DELETE_ALL_TITLE: '全部删除',
  MSG_DELETE_ALL_CONTENT: '确认删除全部消息吗？已读与未读都会被删除，删除后不可恢复。',
  MSG_DELETE_ALL_CONFIRM: '删除',
  MSG_DELETE_ALL_EMPTY: '当前没有可删除的消息',
  // ---------------- 公告（跑马灯 / 全局通知条） ----------------
  ANNOUNCE_TAB: '公告',
  ANNOUNCE_MARQUEE_LABEL: '公告',
  ANNOUNCE_SCOPE_MARQUEE: '首页跑马灯',
  ANNOUNCE_SCOPE_NOTICE: '全局通知条',
  ANNOUNCE_CONTENT_PLACEHOLDER: '输入要展示给所有用户的公告内容',
  ANNOUNCE_PUBLISH: '发布公告',
  ANNOUNCE_PUBLISHED: '公告已发布',
  ANNOUNCE_EMPTY: '暂无公告',
  ANNOUNCE_ACTIVE: '生效中',
  ANNOUNCE_INACTIVE: '已下架',
  ANNOUNCE_ON: '上架',
  ANNOUNCE_OFF: '下架',
  ANNOUNCE_PUSH_LABEL: '同时推送到消息中心',
  ANNOUNCE_CLOSABLE_LABEL: '允许用户关闭通知条',
  ANNOUNCE_TIME_TIP: '生效时间可留空（留空=立即生效 / 长期有效）',
  ANNOUNCE_START_PLACEHOLDER: '生效开始 如 2026-09-20 08:00',
  ANNOUNCE_END_PLACEHOLDER: '生效结束 如 2026-09-30 23:59',
  ANNOUNCE_DELETED: '公告已删除',
  ANNOUNCE_SCOPE_EMPTY_TIP: '请选择公告展示位置',
  // ---------------- 管理员后台：批量删除 ----------------
  BATCH_SELECT_ALL: '全选',
  BATCH_DELETE: '删除选中',
  BATCH_DELETE_CONFIRM_TITLE: '批量删除',
  BATCH_DELETE_CONFIRM_CONTENT: '确认删除选中的 {count} 条记录吗？删除后不可恢复（进行中的记录会被自动跳过）。',
  BATCH_DELETE_DONE: '删除完成',
  BATCH_DELETE_EMPTY_TIP: '请先勾选要删除的记录',
  BATCH_SELECTED: '已选 {count} 条',
  BATCH_NONE_SELECTED: '未选择',
  DELETE: '删除',
  ANNOUNCE_CONTENT_EMPTY: '请填写公告内容',
  ANNOUNCE_PUBLISHING: '发布中…',
  BATCH_ONLY_FINISHED_TIP: '只能删除已结束的记录',
  BATCH_SHOW_DEACTIVATED: '显示已注销账号',
  // ---------------- 角标 ----------------
  BADGE_OVERFLOW: '99+',
  BADGE_UNREAD: '未读'
};
...
/**
 * 主题模式 -> 开关状态文案
 * key 与 miniprogram/utils/theme.js 的 MODES 一一对应（auto / light / dark）
 */
const THEME_MODE_TEXT = {
  auto: '跟随系统',
  light: '浅色',
  dark: '深色'
};
...
// 与后端 backend/src/utils/constant.js 的 ANNOUNCE_SCOPE 完全一致
